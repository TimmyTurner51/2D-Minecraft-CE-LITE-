...
// externs (global variables used here)
extern gfx_sprite_t* BlockTextures[];
extern gfx_sprite_t* ItemTextures[];
extern gfx_sprite_t* PlantTextures[];
extern gfx_sprite_t* FoliageTextures[];
